...
public class MyActivity extends Activity
{
  ...
  public void onCreate(Bundle savedInstanceState)
  {
    ...
    ValueAnimator skyAnim = ObjectAnimator.ofInt(findViewById(R.id.car_layout), "backgroundColor", Color.rgb(0x66,
                                                                                                             0xcc,
                                                                                                             0xff),
    ...
    ObjectAnimator cloudAnim1 = ObjectAnimator.ofFloat(findViewById(R.id.cloud1), "x", -350);
